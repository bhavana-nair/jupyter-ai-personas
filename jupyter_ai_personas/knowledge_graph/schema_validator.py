...
class SchemaValidator:
    ...
    def get_actual_schema(self):
        ...
        with self.driver.session() as session:
            ...
            patterns = [(record["from_label"], record["rel_type"], record["to_label"]) for record in pattern_result]
    ...
    def _get_sample_files(self):
        ...
        with self.driver.session() as session:
            # Check for Python files (Class/Function nodes with 'file' property)
