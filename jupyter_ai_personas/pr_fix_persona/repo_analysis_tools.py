...
class RepoAnalysisTools(Toolkit):
    ...
    def analyze_pr_branch(self, repo_name: str, branch_name: str) -> str:
        """Clone and analyze the PR feature branch to create/update knowledge graph"""
        import tempfile
        import subprocess
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                # Analyze the branch and update KG
                analyzer = BulkCodeAnalyzer()
                analyzer.analyze_folder(temp_dir, clear_existing=True)
                
                return f"Successfully analyzed feature branch '{branch_name}' and updated knowledge graph"
                
        except subprocess.CalledProcessError as e:
            return f"Git error: {e.stderr.decode() if e.stderr else str(e)}"
        except Exception as e:
            return f"Error analyzing PR branch: {str(e)}"

    def get_function_source(self, function_name: str, class_name: str = None) -> str:
        """
    ...
    def find_impact_analysis(self, target_name: str, target_type: str = "Function") -> str:
        """
    ...
    def check_dependents_handled(self, pr_diff: str, target_name: str, target_type: str = "Function") -> str:
        ...
        try:
            ...
            dependents_result = self.query_codebase(query)
