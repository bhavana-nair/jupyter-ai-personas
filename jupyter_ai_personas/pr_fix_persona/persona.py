...
class PRFixPersona(BasePersona):
    ...
    def initialize_team(self, system_prompt):
        ...
        pr_fix_team = Team(
            ...
            model=AwsBedrock(id=model_id, session=session),
            instructions=[
                "Coordinate PR comment analysis and code fixing by delegating to specialized agents:",
                "1. Delegate to Context Analyzer for:",
                "   - Code context analysis using knowledge graph",
                "   - Dependency identification",
                "   - Impact assessment of changes",
                "2. Delegate to Comment Analyzer for:",
                "   - PR comment retrieval and analysis",
                "   - Issue identification and prioritization",
                "3. Delegate to Code Fixer for:",
                "   - Code correction implementation",
                "   - Direct commits to PR branch",
                "   - Fix verification",
                "4. Synthesize results and provide unified summary of applied fixes",
